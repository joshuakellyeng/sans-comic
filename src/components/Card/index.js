...
const Card = ({comic, handleAddToCart}) => {
	...
	return (
		<div className="card rounded-none  text-center shadow mx-1 my-1 xl:w-1/5 lg:w-1/4 md:w-1/3 sm:w-full">
			<figure>
				{/* Conditional rendering brought to you by Carmen */}
				<img src={ (renderImg !== "undefined.undefined" ) ? renderImg : cleanjpg } alt={comic.title}/>
			</figure>
			<div className="card-body justify-between">
				...
				<div className="justify-end card-actions">
					{(forSale > "0")?
					<button onClick={() => handleAddToCart(comic)} className="btn btn-primary rounded-none" >Add to Cart</button>:
